...
class Engine:
    def __init__(self, model: model_mod.LanguageModel, tokenizer: tokenizer_mod.PeashooterTokenizer):
        self.model = model
    ...
    def generate(self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42):
        ...
        bos = self.tokenizer.bos_token_id  # if sampled, ends row
        ...
        while True:
            ...
            next_ids = self.model.sample_next_token(logits, rng, temperature, top_k)  # (B, 1)
            ...
            for i, state in enumerate(row_states):
                ...
                if next_token == python_start:
                    ...
                    if state.python_expr_tokens:
                        ...
                        result = tool.use_calculator(expr)
